...
html`<div style="display: flex; flex-direction: column; align-items: center; color: white;">
  ...
  <div style="width: 90%; text-align: center;">
    ...
    <p style="font-size: 1.2em;"><strong>Release Date:</strong> ${selectedMovie.release_date}</p>
    ...
    <p style="font-size: 1.2em; text-align: justify;"><strong>Overview:</strong> ${selectedMovie.overview}</p>
  </div>
</div>`
...
<div style="display: flex; justify-content: flex-start; align-items: center; height: 50px; padding: 0 20px;">
  <img src="images/logo.png" alt="Creator Logo" style="height: 40px; max-width: 100%; object-fit: contain; margin-right: 10px;">
